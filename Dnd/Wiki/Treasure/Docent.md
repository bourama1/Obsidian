...
**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a d6): (1–2) [detect evil and good](https://5e.tools/spells.html#detect%20evil%20and%20good_phb) or (3–6) [detect magic](https://5e.tools/spells.html#detect%20magic_phb). The docent decides when to cast the spell.
